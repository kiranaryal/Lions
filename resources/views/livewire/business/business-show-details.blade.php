            ...
            <div class="col-span-1 lg:col-span-5 bg-gray-50 rounded-xl p-5 shadow-lg  ">
                <div class="flex items-center">
                    <div class="flex items-center justify-center">
                        <img src="{{ $this->business->getLogo() }}" alt=""
                    ...
                    <div class="flex flex-row justify-between w-full">
                        ...
                        <div>
                            ...
                            <div>
                                <h1>{{ $business->name }}</h1>
                                <button wire:click="toggleState()"
                                    class="font-bold py-2 ">
                                    <p> @if($business->status)
                                        <i class="fa-solid fa-check fa-2xl" style="color: #63E6BE;"></i>
                                        @else<i class="fa-solid fa-xmark fa-2xl" style="color: #ff0000;"></i>
                                        @endif
                                </button>
                            </div>
                            <button
                ...
                <div class="mt-10 flex justify-between ">
                    <a href="{{ $this->business->website }}" class="underline text-sm truncate" target="_blank"
                        rel="noopener noreferrer"> {{ $this->business->website }}</a>
