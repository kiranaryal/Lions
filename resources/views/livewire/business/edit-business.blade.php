<div class="w-full">
    ...
    <!-- Your form content -->
    <x-profile-extra-form submit="update">
            ...
            <div class="col-span-12 gap-10 ">
                ...
                <div class=" ">
                    ...
                    <div class="grid grid-cols-2 gap-5 ">
                        ...
                        <x-label for="" class="col-span-12 w-full text-center text-xl" value="{{ __('Business Category') }}" />
                        <div class="col-span-12 w-full p-2">
                            @foreach($this->businessCategory as $cate)
                            <div class=" flex justify-between ">
                               <div>{{ $cate->name}}</div>
                               <div  wire:click="delete({{$cate->id}})" class="hover:cursor-pointer" >
